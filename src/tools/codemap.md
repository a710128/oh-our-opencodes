...
The `src/tools/` directory provides the core tool implementations for the oh-our-opencodes plugin. It exposes three main categories of tools:
...
- **Install location**: `~/.cache/oh-our-opencodes/bin/rg` (Linux/macOS), `%LOCALAPPDATA%\oh-our-opencodes\bin\rg.exe` (Windows)
...
- **Install location**: `~/.cache/oh-our-opencodes/bin/sg` (Linux/macOS), `%LOCALAPPDATA%\oh-our-opencodes\bin\sg.exe` (Windows)
